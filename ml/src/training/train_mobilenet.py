...
def main():
    ...
    parser.add_argument("--out-weights", default="ml/weights/mobilenet_best.pt", help="Output path for best checkpoint weights.")
    parser.add_argument("--out-history", default="ml/weights/mobilenet_history.json", help="Output JSON path for training history.")
